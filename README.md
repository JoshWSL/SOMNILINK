...
Diese App entstand im Rahmen eines Semesterprojektes an der Technischen Hochschule Ulm.
...
- Selbstständige Dokumentation des Krankheitsverlaufes der Patienten über Fragebögen und ein Tagebuch
- Visualisieren des Krankheitsverlaufes anhand berechneter Scores der Fragebögen
...
|home_page.dart        | Landingpage / Wahl von Daten eingeben und Daten anzeigen       |
...
|info_page.dart| Page mit Informationen über RLS, Verweis auf RLS e. V. und Hintergrund zu Fragebögen |
...
|calendar_tagebuch_page.dart| Kalender, um das Datum des gewünschten Tagebuchs zur Visualisierung anzuzeigen |
|visualize_tagebuch_page.dart| Page bildet Daten von ausgewähltem Tagebucheintrag ab |
...
Die SOMNILINK User-App kann wie folgt gestartet werden:
1. Repository klonen
2. Django-Backend starten
3. Firely-Server starten
4. Projekt in VSC öffnen: `flutter run -d chrome` (Chrome ggf. durch anderen Emulator ersetzen)

Voraussetzung ist die Installation von Flutter, Dart und einigen SDKs. Letzteres sollte allerdings automatisch von VSC zur Installation vorgeschlagen werden.